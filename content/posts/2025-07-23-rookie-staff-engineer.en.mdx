...
How many things in this world are _truly_ irreplaceable?
...
Designing it so that someone else _can_ do it—that’s another level.
...
I love this quote from _I May Be Wrong_:
...
The belief that we can control _everything_ is, by definition, a delusion.
...
but I _do_ want to share this thought:
...
And when new information arrives, it’s okay to _update_.
